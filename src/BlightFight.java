...
public class BlightFight {
    ...
    private Condition playerConditions;
    ...
    public void start() { // name and weapon choice
        ...
        System.out.println("Select your weapon out of these three: (type \"guandao\", \"chakrams\", or \"scythe\")");
        System.out.println("-----GUANDAO------");
        ...
        System.out.println("Dodge: 25%");
        System.out.println("Number of attacks: 4");
        System.out.println();
        ...
        System.out.println("Dodge: 5%");
        System.out.println("Number of attacks: 1");
        System.out.println("Dodge chance: 5%" + Colors.RESET);

        String weaponChoice = scan.nextLine().toLowerCase();
        ...
        while (weaponChoice.equals("")) {
            ...
            weaponChoice = scan.nextLine().toLowerCase();
        }
        while (!weaponChoice.equals("guandao") && !weaponChoice.equals("chakrams") && !weaponChoice.equals("scythe")) {
            System.out.println("\nMistype?");
            System.out.println("-----GUANDAO------");
            System.out.println("Attack: 15");
            System.out.println("Defense: 10");
        ...
        if (weaponChoice.equals("guandao")) {
            player = new Player(name, 150, 15, 10, 10, 10, 2);
        } else if (weaponChoice.equals("chakrams")) {
            player = new Player(name, 150, 5, 5, 20, 25, 4);
        } else if (weaponChoice.equals("scythe")) {
            player = new Player(name, 150, 25, 20, 5, 5, 1);
        }
        turnCount = 2;
        lore();
    }
...
//        }
//    }
//    public void dodgeAttack(int damage) {
//        int percent = (int) (Math.random() * 100) + 1;
//
//        if (getDodge() >= percent) {
//
